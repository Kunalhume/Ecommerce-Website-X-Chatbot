        ...
        <div className="row justify-content-center">
                ...
                <div className="card" style={stylecard}>
                    <div className="cardHeader text-white" style={styleHeader}>
                        <h1 style={{marginBottom:'0px' }}><i>Shree AI</i></h1>
                                    ...
                                    {user.sender==='bot' ?
                                        (
                                            ...
                                            <div className= 'msgalignstart'>
                                                <SmartToyIcon className="botIcon"  /><h5 className="botmsg">{user.msg}</h5>
                                            </div>
                                        ...
                                        :(
                                            <div className= 'msgalignend'>
                                                <h5 className="usermsg">{user.msg}</h5><PersonIcon className="userIcon" />
                                            </div>
                                        )
                                    }
                                </div>
                        ...
                        <div className="row">
                            <form style={{display: 'flex'}} onSubmit={handleSubmit}>
                                ...
                                <div className="col-2 cola">
                                    <button type="submit" className="circleBtn" ><SendIcon className="sendBtn" /></button>
                                </div>
                            </form>
                        </div>
                    </div>
